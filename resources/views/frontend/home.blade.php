...
@section('content')
                    ...
                    <div class="about__thumb-wrapper d-sm-flex mr-20 p-relative">
                        <div class="about__shape">
                            <img class="about__shape-1 d-none d-sm-block"
                                src="{{ asset('frontend_frontend_assets/img/about/about-shape-1.png') }}" alt="">
                            <img class="about__shape-2 d-none d-sm-block"
                                src="{{ asset('frontend_frontend_assets/img/about/about-shape-2.png') }}" alt="">
                            <img class="about__shape-3"
                                src="{{ asset('frontend_frontend_assets/img/about/about-shape-3.png') }}" alt="">
                        </div>
    ...
    <section class="counter__area pb-120" id="statistic">
        <div class="container">
            <div class="section__title-wrapper mb-15">
                <span class="section__title-pre">BAMBU APUS</span>
                <h2 class="section__title">Alur & Statistik Pelaporan</h2>
            </div>
            <div class="counter__inner grey-bg-2">
                <div class="row">
                    <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                        <div
                            class="blog__item-float blog__item-float-overlay p-relative fix transition-3 d-flex align-items-end">
                            <div class="blog__thumb-bg w-img fix"
                                data-background="{{ asset('uploads/' . $about->flowchart_image) }}"
                                style="background-image: url({{ asset('uploads/' . $about->flowchart_image) }});"></div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="counter__icon mr-15">
                                        <svg width="44" height="41" viewBox="0 0 44 41" fill="none"
                                            ...
                                            <path class="star"
                                                ...
                                                fill="#F5F6F8" stroke="#258e46" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </div>
                                    <div class="counter__content">
