...
<body>
    ...
    <div id="loading">
        <div id="loading-center">
            <div id="loading-center-absolute">
                ...
                <img src="frontend_assets/img/favicon.png" alt="">
            </div>
        </div>
    </div>
    <!-- pre loader area end -->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6 col-6">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="frontend_assets/img/logo/logo.png" alt="logo">
                                </a>
                            </div>
                        </div>
    ...
    <main>
                ...
                <div class="swiper-wrapper">
                    <div
                        ...
                        <div class="slider__bg slider__overlay include-bg"
                            data-background="frontend_assets/img/slider/slider-1.jpg"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                                    <div class="slider__content p-relative z-index-1">
                                        ...
                                        <h2 class="slider__title" data-animation="fadeInUp" data-delay=".6s">
                                            Institution of Higher Education</h2>
                                        <p data-animation="fadeInUp" data-delay=".9s">We believe everyone should have
                                            the opportunity to create progress through technolog.</p>
                    ...
                    <div
                        class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
                        <div class="slider__bg slider__overlay include-bg"
                            data-background="frontend_assets/img/slider/slider-2.jpg"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xxl-7 col-xl-8 col-lg-8 col-md-10 col-sm-10">
                                    <div class="slider__content p-relative z-index-1">
                                        <span data-animation="fadeInUp" data-delay=".3s">eduker University</span>
                                        <h2 class="slider__title" data-animation="fadeInUp" data-delay=".6s">Together
                                            We'll Explore New Things</h2>
                                        <p data-animation="fadeInUp" data-delay=".9s">We believe everyone should have
                                            the opportunity <br> to create progress through technolog.</p>
                                        <div class="slider__btn" data-animation="fadeInUp" data-delay="1.1s">
                                            <a href="course-v1.html" class="tp-btn">Find Courses</a>
                                        </div>
                                    </div>
                ...
                <div class="features__inner p-relative z-index-1 white-bg">
                    <div class="row">
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                            <div
                                class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
                    ...
                    <div class="col-xxl-7 col-xl-7 col-lg-7">
                        <div class="about__thumb-wrapper d-sm-flex mr-20 p-relative">
                            <div class="about__shape">
                                ...
                                <img class="about__shape-3" src="frontend_assets/img/about/about-shape-3.png"
                                    alt="">
                            </div>
                                ...
                                <div class="counter__icon mr-15">
                                    <svg width="44" height="41" viewBox="0 0 44 41" fill="none"
                                        ...
                                        <path class="star"
                                            ...
                                            fill="#F5F6F8" stroke="#3D6CE7" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div class="counter__content">
                ...
                <div class="row">
                        ...
                        <div class="course__item white-bg transition-3 mb-30">
                            <div class="course__thumb w-img fix">
                                <a href="course-details.html">
                                    <img src="frontend_assets/img/course/course-1.jpg" alt="">
                                </a>
                            </div>
                            <div class="course__content p-relative">
                                ...
                                <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                    <div class="course__tutor">
                                        <a href="#"><img
                                                src="frontend_assets/img/course/tutor/course-tutor-1.jpg"
                                                alt="">Brian Cumin</a>
                                    </div>
                                    <div class="course__lesson">
                                        <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#49535B" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path
                                                    ...
                                                    stroke="#49535B" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M4.17647 4.5H9.82353" stroke="#49535B"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.17647 6.94995H7.70589" stroke="#49535B"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                            12 Lessons
                                        </a>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                        <div class="course__item white-bg transition-3 mb-30">
                            <div class="course__thumb w-img fix">
                                <a href="course-details.html">
                                    <img src="frontend_assets/img/course/course-2.jpg" alt="">
                                </a>
                            </div>
                            <div class="course__content p-relative">
                                <div class="course__price">
                                ...
                                <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                    <div class="course__tutor">
                                        <a href="#"><img
                                                src="frontend_assets/img/course/tutor/course-tutor-2.jpg"
                                                alt="">Jack Morkel</a>
                                    </div>
                                    <div class="course__lesson">
                                        <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                        <div class="course__item white-bg transition-3 mb-30">
                            <div class="course__thumb w-img fix">
                                <a href="course-details.html">
                                    <img src="frontend_assets/img/course/course-3.jpg" alt="">
                                </a>
                            </div>
                            <div class="course__content p-relative">
                                <div class="course__price">
                                ...
                                <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                    <div class="course__tutor">
                                        <a href="#"><img
                                                src="frontend_assets/img/course/tutor/course-tutor-3.jpg"
                                                alt="">Hilary Ouse</a>
                                    </div>
                                    <div class="course__lesson">
                                        <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                        <div class="course__item white-bg transition-3 mb-30">
                            <div class="course__thumb w-img fix">
                                <a href="course-details.html">
                                    <img src="frontend_assets/img/course/course-4.jpg" alt="">
                                </a>
                            </div>
                            <div class="course__content p-relative">
                                <div class="course__price">
                                ...
                                <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                    <div class="course__tutor">
                                        <a href="#"><img
                                                src="frontend_assets/img/course/tutor/course-tutor-4.jpg"
                                                alt="">Phanta Bear</a>
                                    </div>
                                    <div class="course__lesson">
                                        <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                        <div class="course__item white-bg transition-3 mb-30">
                            <div class="course__thumb w-img fix">
                                <a href="course-details.html">
                                    <img src="frontend_assets/img/course/course-5.jpg" alt="">
                                </a>
                            </div>
                            <div class="course__content p-relative">
                                <div class="course__price">
                                ...
                                <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                    <div class="course__tutor">
                                        <a href="#"><img
                                                src="frontend_assets/img/course/tutor/course-tutor-5.jpg"
                                                alt="">Hilary Ouse</a>
                                    </div>
                                    <div class="course__lesson">
                                        <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                        <div class="course__item white-bg transition-3 mb-30">
                            <div class="course__thumb w-img fix">
                                <a href="course-details.html">
                                    <img src="frontend_assets/img/course/course-6.jpg" alt="">
                                </a>
                            </div>
                            <div class="course__content p-relative">
                                <div class="course__price">
                                ...
                                <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                    <div class="course__tutor">
                                        <a href="#"><img
                                                src="frontend_assets/img/course/tutor/course-tutor-6.jpg"
                                                alt="">Oliver Porter</a>
                                    </div>
                                    <div class="course__lesson">
                                        <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                ...
                <div class="row grid">
                    ...
                    <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 grid-item">
                        <div class="campus__thumb w-img mb-30">
                            <img src="frontend_assets/img/campus/campus-2.jpg" alt="">
                            <a href="https://www.youtube.com/watch?v=AjgD3CvWzS0"
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
                        <div class="campus__thumb w-img mb-25">
                            <img src="frontend_assets/img/campus/campus-3.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 grid-item">
                        <div class="campus__thumb w-img mb-30">
                            <img src="frontend_assets/img/campus/campus-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
                        <div class="campus__thumb w-img mb-30">
                            <img src="frontend_assets/img/campus/campus-4.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="research__area research__border grey-bg-3 pt-115 pb-90 p-relative z-index-1">
            <div class="research__shape">
                <img class="research__shape-1 d-none d-sm-block"
                    src="frontend_assets/img/research/research-shape-1.png" alt="">
                <img class="research__shape-2 d-none d-sm-block"
                    src="frontend_assets/img/research/research-shape-2.png" alt="">
                <img class="research__shape-3" src="frontend_assets/img/research/research-shape-3.png"
                    alt="">
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="research__item research__item-border text-center mb-30 transition-3">
                            <div class="research__thumb mb-35">
                                <img src="frontend_assets/img/research/research-1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="research__item research__item-border active text-center mb-30 transition-3">
                            <div class="research__thumb mb-35">
                                <img src="frontend_assets/img/research/research-2.jpg" alt="">
                            </div>
                            <div class="research__content">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="research__item text-center mb-30 transition-3">
                            <div class="research__thumb mb-35">
                                <img src="frontend_assets/img/research/research-3.jpg" alt="">
                            </div>
                            <div class="research__content">
        ...
        <section class="blog__area pt-120 pb-85 p-relative">
            <div class="blog__shape">
                <img class="blog__shape-1" src="frontend_assets/img/blog/blog-shape-1.png" alt="">
                <img class="blog__shape-2" src="frontend_assets/img/blog/blog-shape-2.png" alt="">
                <img class="blog__shape-3" src="frontend_assets/img/blog/blog-shape-3.png" alt="">
                <img class="blog__shape-4" src="frontend_assets/img/blog/blog-shape-4.png" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xxl-12">
                    ...
                    <div class="col-xxl-6 col-xl-6">
                        <div
                            ...
                            <div class="blog__thumb-bg w-img fix"
                                data-background="frontend_assets/img/blog/blog-1.jpg"></div>
                            <div class="blog__content-float">
                                ...
                                <div class="blog__meta-float">
                                    <ul>
                                        ...
                                        <li>
                                            <span><svg width="16" height="14" viewBox="0 0 16 14"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6">
                            <div class="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                                ...
                                <div class="cta__content">
                                    ...
                                    <p>Teach what you love. Learned gives you neccessary tools to become an instructor.
                                    </p>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6">
                            <div class="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                                ...
                                <div class="cta__content">
                                    ...
                                    <p>Course completed? Then its time apply the certificate Do it in simplesteps with
                                        Learned.</p>
    ...
    <script src="frontend_assets/js/vendor/waypoints.js"></script>
    <script src="frontend_assets/js/bootstrap-bundle.js"></script>
    <script src="frontend_assets/js/meanmenu.js"></script>
    <script src="frontend_assets/js/swiper-bundle.js"></script>
    <script src="frontend_assets/js/owl-carousel.js"></script>
    <script src="frontend_assets/js/magnific-popup.js"></script>
    <script src="frontend_assets/js/parallax.js"></script>
    <script src="frontend_assets/js/backtotop.js"></script>
    <script src="frontend_assets/js/nice-select.js"></script>
    <script src="frontend_assets/js/counterup.js"></script>
    <script src="frontend_assets/js/wow.js"></script>
    <script src="frontend_assets/js/isotope-pkgd.js"></script>
    <script src="frontend_assets/js/imagesloaded-pkgd.js"></script>
